...
func TestComputeFingerprint_DifferentReferenceIDProducesDifferentHash(t *testing.T) {
	r := mustRecipient(t, `{"email":"a@example.com"}`)

	fp1 := domain.ComputeFingerprint(domain.ChannelEmail, r, "X", "Y", "r1")
	fp2 := domain.ComputeFingerprint(domain.ChannelEmail, r, "X", "Y", "r2")
